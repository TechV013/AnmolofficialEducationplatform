...
export const metadata: Metadata = { title: "Create Course — Instructor", robots: { index: false, follow: false } };
import { authorizeRole } from "@/lib/auth/guard";
import { createCourse } from "@/app/instructor/courses/[courseId]/actions";

export default async function InstructorCreateCoursePage() {
  await authorizeRole("INSTRUCTOR"); // Instructors can view; action is ADMIN-only anyway
  return (
    <div className="p-12 max-w-2xl mx-auto bg-background min-h-screen text-text">
      <h1 className="text-3xl font-bold mb-6">Create New Course</h1>
      <p className="text-muted mb-6">Only ADMIN users may create courses. If you need a new course assigned to you, contact an admin.</p>
